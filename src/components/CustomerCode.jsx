...
function CustomerCode() {
  ...
  return (
    <div className="CustomerCode-container">
      <motion.div
        className="CustomerCode-form"
        initial={{ y: 60, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        transition={{ duration: 1, ease: "easeOut", delay: 0.4 }}
      >
        <div className="CustomerCode-form-fields">
          <form>
            <h3 className="CustomerCode-title">
            ...
            <Link
              to={isOtpComplete ? "/CustomerNewPassword" : "#"}
            ...
            >
              <button type="button" className="btn-CustomerCode-container">
                تأكيد
              </button>
            </Link>
            <div>
