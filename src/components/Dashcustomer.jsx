...
const Dashcustomer = () => {
  ...
  const [customers, setCustomers] = useState(() => {
    ...
    return [
      ...
      { id: 2, name: ' علي خالد', location: 'القاهرة', phone: '01122334455', email: 'ali@gmail.com', date: '2026-04-21' },
      { id: 3, name: ' رضا السعيد', location: 'اسيوط', phone: '01255667788', email: 'reda@gmail.com', date: '2026-04-22' },
      { id: 4, name: ' السيد محمد', location: 'قنا', phone: '01566778899', email: 'sayed@gmail.com', date: '2026-04-23' },
    ];
  });
            ...
            {displayedCustomers.map((customer, index) => (
              <tr key={customer.id} data-aos="fade-up">
                ...
                <td className="actions-btns">
                  <button className="view-btn" onClick={() => navigate(`/Clientprofile/${customer.id}`)}>عرض</button>
                  <button className="delete-btn" onClick={() => handleDelete(customer.id)}>حذف</button>
                </td>
              </tr>
            ))}
          </tbody>
