...
function CompanyCode() {
  ...
  return (
    <div className="CompanyCode-container">
      <motion.div
        className="CompanyCode-form"
        initial={{ y: 60, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        transition={{ duration: 1, ease: "easeOut", delay: 0.4 }}
      >
        <div className="CompanyCode-form-fields">
          <form>
            <h3 className="CompanyCode-title">
            ...
            <Link
              to={isOtpComplete ? "/CompanyNewPassword " : "#"}
            ...
            >
              <button type="button" className="btn-CompanyCode-container">
                تأكيد
              </button>
            </Link>
            <div>
