...
const handleEmailChange = (e) => {
  ...
  return (
    <div className="CustomerForgotPassword-container">
      <motion.div
        className="CustomerForgotPassword-form"
        initial={{ y: 60, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        transition={{ duration: 1, ease: "easeOut", delay: 0.4 }}
      >
        <div className="CustomerForgotPassword-form-fields">
          <form onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="field-container">
              ...
              />
              {emailError && (
                <p className="CustomerForgotPassword-error-msg">{emailError}</p>
              )}
            </div>
