...
import "./CraftsmanCode.css";
import { motion } from "framer-motion";
import { Link } from "react-router-dom";

function CraftsmanCode() {
  ...
  return (
    <div className="CraftsmanCode-container">
      <motion.div
        className="CraftsmanCode-form"
        initial={{ y: 60, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        transition={{ duration: 1, ease: "easeOut", delay: 0.4 }}
      >
        <div className="CraftsmanCode-form-fields">
          <form>
            <h3 className="CraftsmanCode-title">
            ...
            <Link
              to={isOtpComplete ? "/CraftsmanNewPassword" : "#"}
            ...
            >
              <button type="button" className="btn-CraftsmanCode-container">
                تأكيد
              </button>
            </Link>
            <div>
