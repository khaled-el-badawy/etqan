...
import "./Footer.css";
import { FaEnvelope, FaPhoneAlt, FaLinkedinIn, FaInstagram, FaTwitter, FaFacebookF } from "react-icons/fa";
...
=======
 const coloredPages = ["/HandyOrdersPage", "/CustomerOrdersPage","/AboutUs","/contactUs","/OrderDetails","/Faturuh"];
               ...
               <div className="footer-container">
                 ...
                 <div className="footer-section">
                   ...
                   <ul className="contact-info">
                     <li><FaEnvelope /> <span>ETQAN@gmail.com</span></li>
                 ...
                 <div className="footer-section policies-section">
                   <ul className='footer-ul'>
                     <li><Link to="#" className='footer-link'>سياسة الخصوصية</Link></li>
                     <li><Link to="#" className='footer-link'>الشروط والأحكام</Link></li>
                   </ul>
                 </div>
               </div>
