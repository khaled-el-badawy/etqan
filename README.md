...
| **⭐ نظام التقييم** | نظام مراجعات وتقييمات شفاف مع أشرطة توزيع التقييمات وإمكانية تقديم الشكاوى. |
...
│   ├── آراء العملاء (Swiper)
│   └── تواصل معنا
├── 🔧 صفحة الخدمات — 20+ تخصص مع بحث
├── 👷 صفحة الحرفيين — تصفح حسب التخصص
├── 🏢 دليل الشركات — تصنيفات (بناء، نقل، تأجير معدات)
├── 🛒 المتجر — منتجات، ماركات، عروض، بحث، خريطة، تقييمات
├── ❤️ المفضلة — منتجات محفوظة مع إضافة جماعية للسلة
├── 🛍️ سلة المشتريات — تحكم بالكميات، ملخص، إتمام الشراء
├── 🧾 الفاتورة — فاتورة مفصلة مع طرق الدفع
├── 👤 الملفات الشخصية
│   ├── ملف الحرفي — معرض أعمال، تقييمات، نموذج تعديل
│   ├── ملف الشركة — إحصائيات، خدمات، تقييمات
│   └── ملف العميل — سجل خدمات، تقييمات، شكاوى
├── 📋 إدارة الطلبات (عميل / حرفي / شركة)
├── 💬 صفحة المحادثة
├── ℹ️ من نحن
├── 📞 تواصل معنا
└── 🚫 صفحة 404
...
| **20+ تخصص حرفي** | تغطية شاملة للحرف (سباكة، نجارة، كهرباء، حدادة، تكييف، دهانات، محارة، بناء، سيراميك، ألومنتال، تكسير، غاز، منجد، نقل، صيانة أجهزة، رش مبيدات، تنظيف، فني دش، أمن ذكي، استشارات هندسية). |
| **ملفات شخصية غنية للحرفيين** | صفحات بورتفوليو مع صور غلاف وأفاتار وشارة توثيق ومعرض أعمال وتقييمات مع توزيع بياني. |
| **متجر إلكتروني متكامل** | كتالوج منتجات مع سلايدر، خصومات، بحث، مفضلة (محفوظة في localStorage)، سلة بحد أقصى 5 قطع، تقييم منتجات، ودليل ماركات. |
...
| **تحقق متقدم من النماذج** | تحقق من البريد الإلكتروني (regex)، أرقام الهاتف المصرية (01x، 11 رقم)، تطابق كلمات المرور، تاريخ الميلاد بقناع `DD/MM/YYYY` مع فحص عمر 18+. |
